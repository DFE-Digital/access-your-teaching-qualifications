...
maintenance-image-push:
	...
	docker build --platform linux/amd64 -t ghcr.io/dfe-digital/access-your-teaching-qualifications-maintenance:${MAINTENANCE_IMAGE_TAG} maintenance_page
	echo ${GITHUB_TOKEN} | docker login ghcr.io -u USERNAME --password-stdin
	docker push ghcr.io/dfe-digital/access-your-teaching-qualifications-maintenance:${MAINTENANCE_IMAGE_TAG}
