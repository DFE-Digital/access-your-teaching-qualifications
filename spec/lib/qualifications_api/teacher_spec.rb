  ...
  describe '#no_restrictions?' do
    ...
    context 'when there are possible restrictions' do
      let(:api_data) do
        {
          "alerts" => [
            { "alert_id" => "7924fe90-483c-49f8-84fc-674feddba848", "start_date" => "2024-01-01" },
    ...
    context "when there are sanctions not listed in the Sanction model" do
      let(:api_data) do
        {
          "alerts" => [
            { "alert_id" => "241eeb78-fac7-4c77-8059-c12e93dc2fae", "start_date" => "2024-01-01" },
          ]
        }
      end
    ...
    context "when there are sanctions that are prohibited" do
      let(:api_data) do
        {
          "alerts" => [
            { "alert_id" => "1a2b06ae-7e9f-4761-b95d-397ca5da4b13", "start_date" => "2024-01-01" },
          ]
        }
      end
