...
ActiveRecord::Schema[7.0].define(version: 2023_08_18_091240) do
  ...
  create_table "organisations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["company_registration_number"], name: "index_organisations_on_company_registration_number", unique: true
  end
